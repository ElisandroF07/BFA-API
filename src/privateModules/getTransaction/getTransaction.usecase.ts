...
export class GetTransactionUseCase {
  ...
  async getTransaction(transactionId: number, response: Response) {
    ...
    const transaction = await prismaClient.transfers.findFirst({ where: { id: transactionId }, select: { accountTo: true, balance: true, date: true, status: true, transfer_type: true, receptor_description: true, emissor_description: true, accountFrom: true, transfer_description: true, id: true } });
