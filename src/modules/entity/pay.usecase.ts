    ...
    try {
      ...
      switch (data.entityReference) {
        ...
        case 673003: {
          ...
          }, select: {authorized_balance: true, available_balance: true, up_balance: true, client: true}})

          await prismaClient.account.update({where: {account_id: entity?.account_id || 0}, data: {
